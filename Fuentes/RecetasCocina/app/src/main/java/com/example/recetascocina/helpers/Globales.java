...
public class Globales {
    public final static String ipUrl = "http://recetasapp.ddns.net:8080/";
    public final static String urlLogin = ipUrl+"login";
    public final static String urlIngredientes = ipUrl+"ingredientes";
